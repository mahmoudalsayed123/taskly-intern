...
"
      ...
      {openModal && (
        <>
          ...
          ></div>
          <div className="w-full p-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-md max-h-198.75 lg:w-2xl lg:max-w-2xl lg:min-h-auto z-200 lg:my-20 bg-red-400">
            <EpicModal
